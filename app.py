...
BLK  = '#0D0D0D'
DARK = '#1A1A1A'
PALETTE = [ORG, GLD, TEAL, '#A8C4E0', '#8B7362', '#1F2260', GRN, RED,
           '#9B59B6','#E74C3C','#1ABC9C','#3498DB','#F39C12','#2ECC71']
...
# ── Chart colors: Mariano Events palette (CSS/theme above untouched) ──
ORG  = '#F0B43C'   # Mariano gold
GLD  = '#D9980E'   # deep gold
TEAL = '#288C8C'   # Mariano teal
PUR  = '#8C1478'   # Mariano purple
...
if _logo64:
    st.markdown(f'''<div style="display:flex;align-items:center;gap:16px;margin-bottom:4px;">
      <img src="data:image/png;base64,{_logo64}" style="height:70px;border-radius:10px;">
      <span style="font-size:2rem;font-weight:900;letter-spacing:2px;color:#F0B43C;font-family:Arial Black;">CAMPAIGN ANALYZER</span>
...
with st.sidebar:
    if _logo64:
        st.markdown(f'<div style="text-align:center;padding:6px 0 12px 0;"><img src="data:image/png;base64,{_logo64}" style="width:120px;border-radius:10px;"></div>', unsafe_allow_html=True)
